...
evecws is special because it is very simple and it does not use any framework. So it is great to read through the code and learn some basics about reading and storing data from EVE API using PHP & MySQL.
